...
## Ingat
  ...
  - Tuning Query
    ...
    :: Setiap nayamain model sama webpac yang lama, cek dulu yang sekiranya berat bikin model baru. gpp banyak model yang penting select sesuai kebutuhan tp outputnya sama
...
=> Ini session, diget ulang jd nambah berat klo banyak session
